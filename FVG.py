...
class Params:
    ...
    mode: str = "medium"  # medium|strictlite
    use_fvg: bool = True
...
def main():
    ...
    ap.add_argument("--mode", choices=["medium","strictlite"], default="medium")
    ...
    while True:
        ...
        for symbol in args.symbols:
            try:
                ...
                p = Params(adx_min=args.adx_min, mode=args.mode, use_fvg=True)
