...
# Force exact training order
                    ...
                    if first_run and label != "HOLD"  and confidence >= 0.50 or (last_signals.get(symbol) != current_signal and label != "HOLD" and confidence >= 0.50):
                        last_signals[symbol] = current_signal

        # Icon for strong signals
                        icon = "✅" if confidence >= 0.75 else "⚠️"
