...
def train_on_file(file_path, model_dir, scaler_dir, features_dir, seq_len=48, epochs=15, batch_size=64):
    ...
    for epoch in range(epochs):
        ...
        print(f"💰 Val Profit: {val_profit:.2f} | Win Rate: {win_rate:.2f}% | Trades: {trades}")
        ...
        if val_profit > best_val_profit:
            ...
            print(f"✅ Model saved to: {coin_symbol}")

# --- Entry Point ---
def train_all_models(data_dir="C:/Users/natec/datasets_macro_training3",
                     model_dir="models_transformer_p",
                     scaler_dir="models_transformer_p/scalers",
                     features_dir="models_transformer_p/features"):
    os.makedirs(model_dir, exist_ok=True)
