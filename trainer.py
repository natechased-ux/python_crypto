...
LOOKAHEAD_CANDLES = 2         # 12 hours forward look
...
if all_data:
    ...
    dataset.to_csv("lstm_training_dataset.csv", index=False)
    print(f"✅ Dataset saved: {dataset.shape[0]} rows, {dataset.shape[1]} columns → lstm_training_dataset.csv")
else:
