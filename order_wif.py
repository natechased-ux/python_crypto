...
def analyze_order_book(symbol):
    ...
    if response.status_code == 200:
        ...
        if response_full.status_code == 200:
            ...
            print("\nFirst Decision:")
            print(f"{first_decision} to {format_price(first_execution_price)}" if first_execution_price else "NO POSITION")
            ...
            for decision, price in decisions[1:]:
                print(f"{decision} to {format_price(price)}" if price else "NO POSITION")
