...
# Targets / Tuning
TARGET_ALERTS_PER_DAY = float(os.getenv("TARGET_ALERTS_PER_DAY", "0.6")) # per coin
...
WINRATE_TARGET     = float(os.getenv("WINRATE_TARGET", "0.8"))
...
if __name__ == "__main__":
    ...
    # Kraken WS started in class instantiation
        # Start outcome monitor to close trades and compute MAE/MFE
