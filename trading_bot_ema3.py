...
- 1D EMA stack is bullish (EMA25 > EMA50)
- EMAs are rising
...
- ideal_entry (EMA pullback, range low, or continuation trigger)
- stop_loss (EMA-based or structure-based)
- take_profits (measured move or trend continuation targets)
